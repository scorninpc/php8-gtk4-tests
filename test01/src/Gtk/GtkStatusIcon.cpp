...
Php::Value GtkStatusIcon_::gtk_status_icon_new_from_pixbuf(Php::Parameters &parameters)
{
	GdkPixbuf *pixbuf;
	Php::Value object_pixbuf = parameters[0];
	GdkPixbuf_ *phpgtk_pixbuf = (GdkPixbuf_ *)object_pixbuf.implementation();
	...
	GtkStatusIcon* ret = gtk_status_icon_new_from_pixbuf(GTK_STATUS_ICON(instance), pixbuf);
...
Php::Value GtkStatusIcon_::gtk_status_icon_new_from_file(Php::Parameters &parameters)
{
	std::string c_filename = parameters[0];

	gchar *filename = (gchar *)c_filename.c_str();

	GtkStatusIcon* ret = gtk_status_icon_new_from_file(GTK_STATUS_ICON(instance), filename);
...
Php::Value GtkStatusIcon_::gtk_status_icon_new_from_stock(Php::Parameters &parameters)
{
	std::string c_stock_id = parameters[0];

	gchar *stock_id = (gchar *)c_stock_id.c_str();

	GtkStatusIcon* ret = gtk_status_icon_new_from_stock(GTK_STATUS_ICON(instance), stock_id);
...
Php::Value GtkStatusIcon_::gtk_status_icon_new_from_icon_name(Php::Parameters &parameters)
{
	std::string c_icon_name = parameters[0];

	gchar *icon_name = (gchar *)c_icon_name.c_str();

	GtkStatusIcon* ret = gtk_status_icon_new_from_icon_name(GTK_STATUS_ICON(instance), icon_name);
