...
{
	GtkShadowType ret = gtk_viewport_get_shadow_type(GTK_VIEWPORT(instance));
...
{
	GdkWindow* ret = gtk_viewport_get_bin_window(GTK_VIEWPORT(instance));
...
{
	GdkWindow* ret = gtk_viewport_get_view_window(GTK_VIEWPORT(instance));


	return cobject_to_phpobject(ret);
}

Php::Value GtkViewport_::gtk_viewport_get_type()
{
	GType ret = gtk_viewport_get_type(GTK_VIEWPORT(instance));
